...
float points[] = {
  ...
  -0.95, -0.95, -0.95, 0.0f, 0.0f, // 0 - Bottom Left Front
  0.95,  -0.95, -0.95, 1.0f, 0.0f,// 1 - Top Left Front
   0.95,  0.95, -0.95, 1.0f, 1.0f,// 2 - Top Right Front
   -0.95, 0.95, -0.95, 0.0f, 1.0f, // 3 - Bottom Right Front
   -0.95, -0.95,  0.95, 0.0f, 0.0f,// 4 - Bottom Right Back
   0.95,  -0.95,  0.95, 1.0f, 0.0f, // 5 - Top Right Back
  0.95,  0.95,  0.95,  1.0f, 1.0f,// 6 - Top Left Back
  -0.95, 0.95,  0.95,  0.0f, 1.0f,// 7 - Bottom Left Back
};
...
void initVertexBufferGL(void) {
  ...
  glVertexAttribPointer(texCoordLoc, 2, GL_FLOAT, GL_FALSE, 0, (void*)0);
